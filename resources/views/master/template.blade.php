            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text fw-bolder ms-2">UNI BOOK STORE</span>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Layouts">Penerbit</div>
                        </a>

                        <ul class="menu-sub">

                            <li class="menu-item">
                                <a href="{{route('penerbit')}}" class="menu-link">
                                    <div data-i18n="Without navbar">Data Penerbit</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{route('penerbit.create')}}" class="menu-link">
                                    <div data-i18n="Container">Tambah Data</div>
                                </a>
                            </li>
                    ...
                    <li class="menu-item ">
                        <a href="{{route('pengadaan')}}" class="menu-link">
                            <i class="menu-icon tf-icons fa-solid fa-object-group"></i>
