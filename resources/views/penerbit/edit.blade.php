...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Data Penerbit</li>
    </ol>
</nav>
@endsection
@section('button')
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="kode" value="{{$item->kode}}" class="form-control @error('kode') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Kode Buku" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
            </div>
            @error('kode')
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="nama_penerbit" value="{{$item->nama}}" class="form-control @error('nama_penerbit') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Nama Penerbit" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('nama_penerbit')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="kota" value="{{$item->kota}}" class="form-control @error('kota') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Kota" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('kota')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-fullname2" class="input-group-text"><i class="fa-solid fa-square"></i></span>
                <input type="number" name="telp" value="{{$item->telpon}}" class="form-control @error('telp') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="telp" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('telp')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-10">
              <div class="input-group input-group-merge">
                ...
                <textarea type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Masukan Alamat" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" cols="30" rows="10">{{$item->alamat}}</textarea>
              </div>
              @error('alamat')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
