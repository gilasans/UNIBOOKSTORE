          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="kode" value="{{$data->kode}}" class="form-control @error('kode') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Kode Buku" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
            </div>
            @error('kode')
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="nama_buku" value="{{$data->nama_buku}}" class="form-control @error('nama_buku') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Nama Buku" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('nama_buku')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <input type="number" name="harga" value="{{$data->harga}}" class="form-control @error('harga') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Stok" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('harga')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-fullname2" class="input-group-text"><i class="fa-solid fa-square"></i></span>
                <input type="number" name="stok" value="{{$data->stok}}" class="form-control @error('stok') is-invalid @enderror" id="basic-icon-default-fullname" placeholder="Stok" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
              </div>
              @error('stok')
                  <p class="text-danger">{{ $message }}</p>
              @enderror
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <select id="defaultSelect" class="form-select @error('kategori') is-invalid @enderror" name="kategori" value="{{old('kategori')}}">
                    ...
                    @foreach ($ktg as $item)
                    <option value="{{$item->id}}"@selected($item->id == $data->kategori_id)>{{$item->kategori}}</option>
                    @endforeach
                  </select>
              </div>
              @error('kategori')
            ...
            <div class="col-sm-10 col-md-4">
              <div class="input-group input-group-merge">
                ...
                <select id="defaultSelect" class="form-select @error('penerbit') is-invalid @enderror" name="penerbit" value="{{old('penerbit')}}">
                    ...
                    <option value="{{$png->id}}" @selected($png->id == $data->penerbit_id)>{{$png->nama}}</option>
                    @endforeach
                  </select>
              </div>
              @error('penerbit')
